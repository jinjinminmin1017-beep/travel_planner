...
from app.data_sources.map_providers import MapRouteEstimate, data_source_metadata
...
def fake_real_rail_provider_for_planner(monkeypatch):
    def fake_search(request, environment=None):
        source = rail_data_source_metadata("rail_authorized_partner", "Authorized Rail Partner API")
        ...
        base_minor = 52600 if request.train_number.startswith("G") else 30000
