    ...
    def repair_intent(
        ...
        user_prompt = "\n".join(
            [
                ...
                "",
                "target_schema: TravelRequest Schema V1.18",
                "",
                "error_reasons:",
    ...
    def repair_recommendation(self, llm_input: LLMRecommendationInput, invalid_reasons: list[str]) -> LLMRecommendationOutput:
        ...
        user_prompt = "\n".join(
            [
                ...
                "",
                "target_schema: LLMRecommendationOutput Schema V1.18",
                "",
                "error_reasons:",
                "\n".join(f"- {reason}" for reason in invalid_reasons),
                "",
                ...
                "",
                "Return repaired JSON for LLMRecommendationOutput Schema V1.18.",
                "",
